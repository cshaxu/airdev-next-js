...
import * as UserDelivery from '@/backend/deliveries/user';
...
export const executor = async (body: PostmarkWebhookBody, context: Context) => {
  const slack = await UserDelivery.sendSlack(body, context);
