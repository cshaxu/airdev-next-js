...
function Calendar({
  ...
  const _dayButtonClassName = cn(
    ...
    'size-8 rounded-md p-0 font-normal transition-none aria-selected:opacity-100 hover:bg-accent hover:text-accent-foreground',
    props.dayButtonClassName
  );
  const buttonRangeClassName =
    'bg-accent [&>button]:bg-primary [&>button]:text-primary-foreground [&>button]:hover:bg-primary-hover [&>button]:hover:text-primary-foreground';
