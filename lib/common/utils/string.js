...
export function quantify(count, singular, asDenominator = false, plural) {
...
export function quantifyMany(array) {
    if (array.length === 0) {
        return 'none';
    }
    const phrases = array
...
export function formatString(template, defaultNameVars, data) {
