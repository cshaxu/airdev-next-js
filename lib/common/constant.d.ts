...
export declare const ADMIN_API_HREF = "/admin/api";
export declare const ADMIN_USERS_HREF = "/admin/users";
...
export declare const PRIVACY_HREF = "/privacy";
export declare const ROOT_HREF = "/";
export declare const SETTINGS_HREF = "/settings";
export declare const TERMS_HREF = "/terms";
