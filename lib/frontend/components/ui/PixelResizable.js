...
const PixelResizablePanel = React.forwardRef(({ children, className, collapsedSize, minSize, maxSize, defaultSize, isCollapsed = false, onCollapseChange, onResize, style, ...props }, ref) => {
    ...
    return (_jsxs("div", { ref: ref, className: cn('relative flex h-full flex-col overflow-hidden', className), style: { ...style, width: isCollapsed ? collapsedSize : width }, ...props, children: [children, _jsx("div", { className: "bg-border hover:bg-primary focus-visible:ring-ring absolute top-0 right-0 h-full w-px cursor-ew-resize select-none after:absolute after:inset-y-0 after:left-1/2 after:w-4 after:-translate-x-1/2 focus-visible:ring-1 focus-visible:ring-offset-1 focus-visible:outline-none", onMouseDown: handleMouseDown })] }));
});
