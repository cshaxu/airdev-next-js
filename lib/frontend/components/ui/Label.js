...
const labelVariants = (0, class_variance_authority_1.cva)('text-sm font-medium text-muted-foreground leading-6 mb-1.5 peer-disabled:cursor-not-allowed peer-disabled:opacity-70');
