...
export default function UserSearch() {
    ...
    async function handleSearch(q = inputQ.trim()) {
        const nextUsers = (await searchUsers({ q }));
        setUsers(nextUsers);
    }
    useEffect(() => {
        void handleSearch('');
