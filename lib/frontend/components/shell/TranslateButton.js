...
export default function TranslateButton() {
    ...
    return (_jsx(_Fragment, { children: showGoogleTranslate ? (_jsx("div", { id: "google_translate_element", style: {
                display: 'inline-flex',
                alignItems: 'center',
                width: '100%',
                minWidth: '300px',
                ...
                height: '32px',
                whiteSpace: 'nowrap',
            } })) : (_jsx(Button, { variant: "ghost", onClick: () => setShowGoogleTranslate(true), children: _jsx(Globe, { className: "size-4" }) })) }));
}
