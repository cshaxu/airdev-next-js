...
export async function batchExecuteByPageParam(loader, executor, pageParamMapper, batchSize = privateConfig.database.dbBatchSize, initialPageParam = undefined) {
...
export async function filterAsync(array, filter, batchSize = privateConfig.database.dbBatchSize) {
    const result = [];
